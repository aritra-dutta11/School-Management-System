    ...
    if(users.length>0){
            if(secure === users[0].Securecode){
                if(newpass === cnewpass){
                    ...
                    res.render('forgotpasswordadmin',{message: 'Passwords did not match'})
                }
            }
            else{
                res.render('forgotpasswordadmin',{message: 'Wrong Secure Code'})
            }
    }
    else{
        res.render('forgotpasswordadmin',{message: 'No such user'})
    }
})
